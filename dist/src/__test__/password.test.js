...
describe("PasswordController", () => {
    ...
    describe("addPassword", () => {
        it("should add a new password if not already existing", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            mockReq.body = Object.assign(Object.assign({}, passwordDetails), { websiteUrl: passwordDetails.url }); // Add websiteUrl property for consistency with the controller function
